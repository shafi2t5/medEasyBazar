      ...
      >
        <label htmlFor={searchId} className="flex flex-1 items-center py-0.5">
          <input
            id={searchId}
            className={cn(
              'text-heading outline-none w-full h-[52px] ltr:pl-5 rtl:pr-5 md:ltr:pl-6 md:rtl:pr-6 ltr:pr-14 rtl:pl-14 md:ltr:pr-16 md:rtl:pl-16 bg-brand-light text-brand-dark text-sm lg:text-15px rounded-xl transition-all duration-200 focus:border-brand focus:ring-0 placeholder:text-brand-dark/50',
              {
        ...
        {/* {value ? (
          <button
            ...
            onClick={onClear}
            title="Clear search"
            className="absolute top-2 bottom-2 right-2 flex items-center justify-center h-full transition duration-200 ease-in-out outline-none w-12 md:w-14 hover:text-heading focus:outline-none"
          >
